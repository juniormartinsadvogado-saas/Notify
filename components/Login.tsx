      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-200">
        ...
        <div className="relative z-20 flex flex-col justify-between h-full p-16">
          ...
          <div className="max-w-md">
            ...
            <p className="text-slate-100 text-lg font-light leading-relaxed opacity-90 border-l-2 border-blue-50 pl-6">
              Automação de notificações e gestão processual com a precisão que seu escritório exige.
            </p>
          </div>
        </div>
      </div>
